...
/**
 *Esta clase es una ventana que nos ayudara a hacer el proceso de retiro de montos dela cuenta. 
...
public class Retiro extends javax.swing.JFrame {
    ...
    /**
     * crea una nueva ventana de tipo Retiro.
     */
    public Retiro() {
        initComponents();
     ...
     * y numero de cuenta dela clase por ultimo se carga los datos
    ...
    private void txtRetiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtRetiroActionPerformed
     ...
     /** El método limita a a que solo acepte cuatro caracteres y a solo numeros */
     ...
     * El método verifica si el monto a retirar es menor o igual al saldo 
     * y si lo es resta el monto al saldo .
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (!txtRetiro.getText().equals("")){
            if(Double.parseDouble(txtRetiro.getText()) < (saldo(numeroCuenta))){
                ...
                Historia historia = new Historia (fechaYHoraActual,"Retiro","-"+txtRetiro.getText(),null,000000,saldo(numeroCuenta)+"");
     ...
     * @param numerocuenta numero de cuenta de la cuenta que se busca saber su saldo 
    ...
    /**
     * El método agrega una historia ala lista de historias de la cuenta.
     * @param historia  historia que se agregara ala lista de historias.
     */
     ...
     /**
      * El método actualizara el saldo despues de aver retirado un monto especifico.
      * @param saltoRetirado monto retirado.
      */

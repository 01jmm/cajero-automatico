...
public class SaldoQuechua extends javax.swing.JFrame {
    ...
    /**
     * Crea una ventana de tipo Saldo en el idioma quechua.
     */
     public SaldoQuechua() {
        initComponents();
     ...
     /**
     * crea una nueva ventana de tipo Saldo en el idioma quechua.
    ...
    private void initComponents() {
        ...
        txtSaldo.setText("$$$");
        jPanel1.add(txtSaldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 250, 130, 50));
        ...
        txtMoneda.setText("$$$");
        jPanel1.add(txtMoneda, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 250, 50, 50));

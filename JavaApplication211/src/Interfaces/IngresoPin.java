...
public class IngresoPin extends javax.swing.JFrame {
    ...
    /**
     * Crea un objeto de tipo IngresoPin.
     * el método tambien carga datos ala interfas o clase.
    ...
    /**
     * Maneja el evento de acción cuando se hace clic en el boton "Registrarse"
     * el método redirige ala ventana registro.
     ...
     * El método verifica si el usuario y contraseña son validos y si son redirige ala 
     * ventana Cuentas.
     * @param evt El evento de accion que desencadena esta operacion.
     */
    ...
    /**
     * El método verifica si el usuario existe el la lista de clientes.
     * @param usu nombre de usuario  ingresado desde consola
     * @return  devuelve true si es usuario existe.
     */
    ...
    /**
     * El método verifica si la contraseña es valida.
     * @param contra contraseña  ingresada desde consola.

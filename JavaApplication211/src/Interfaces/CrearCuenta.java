...
/**
 * Esta clase es una ventana para crear una  nueva cuenta .
 * @author Joel Mauricio Mamani Mamani.
 */
public class CrearCuenta extends javax.swing.JFrame {
    /** Variable para guardar el nombre del usuario en toda la clase*/
    public String usuario = "null";
    /** Variable para guardar el numero de cuenta del usuario en toda la clase */ 
     public int numerCuenta = 000;
     /** Variable para saber si la cuenta esta en tipo ahorro*/
     public boolean ahorro = false;
     /** Variable para saber si la cuenta esta en tipo credito*/
     public boolean credito = false;
     /** Variable para saber si la cuenta esta en tipo debito*/    
    ...
    /**
     * Crea una nueva ventana para crear una nueva cuenta.
     * este constructor tambien cambia el nombre de usuario y lee el fichero o carga la clase con los datos  del fichero. 
...
/**
 ...
 private void actualizarLista() {
    ...
    /**
     * Maneja el evento de acción cuando se hace clic en el boton "Crear Cuenta".
     * Este metodo crea una nueva cuenta generando un numero de cuenta que no exista ya, 
     * el usuario sea diferente alos que ya exista , que tipo de cuenta sea y el tipo de moneda que  guardara la cuenta.
     ...
     * El método redirige a la ventana Bienvenida. 
     * @param evt El evento de accion que desencadena esta operacion.
     */
     ...
     * El método redirige a la ventana Cuentas. 
     * @param evt El evento de accion que desencadena esta operacion.
     */
    ...
    /**
     * El metodo es el ultimo paso para crear una cuenta.
     * Este método  guarda el tipo de moneda y crea la cuenta
     * despues redirige ala ventana Cuenta.
    ...
    /**
     * método para saber si el numero de cuenta ya existe.
     * Este método busca en la lista de cuentas si el nuevo numero de cuenta es igual a alguna cuenta 
     * ya existente.
     * @param numerocuenta nuevo numero de cuenta a verificar si existe.
     * @return retorna true si el numero de cuenta ya existe.
     */

...
/**
 * Esta clase es una ventana para hacer transacciones.
...
public class Transferencia extends javax.swing.JFrame {
    ...
    /**
     * Crea una ventana de tipo Transferencia.
     */
...
/**
 ...
 private void actualizarLista() {
    ...
    private void initComponents() {
     ...
     /** El método limita a a que solo acepte cinco caracteres y a solo numeros */
     ...
     * El método verifica si existe la cuenta a quien trasferir y verifica si tu saldo es suficiente 
     * despues de confimar esos datos se trasfiere el saldo a trasferir.
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
     ...
     /**
      * El método ayuda a redondear un numero a tres decimales.
    ...
    /** el método limita que solo acepte numeros y solo nueve caracteres*/
    ...
    /**
     * El método agrega las historias tanto al emimsor y receptor dela transferencia haciendo las modificaciones en la histoiras depende el tipo de 
     * moneda que guarden las distintas cuentas.
     * @param numeroCuentaTransferir numero de cuenta del destinatario de la trasferencia.
    ...
    public void historias(int numeroCuentaTransferir,double saldoTransferir){
         ...
         /**
          * El método agrega las historias tanto al emimsor y receptor dela transferencia.
          * @param numerocuentaCliente numero de cuenta de la que queremos saber el nombre completo del dueño.
    ...
    /**
     * el metodo agrega las histoiras ala lista de historias tanto del emisor como del receptor de la trasnferencia.
     * @param historiaEmisor historia del emisor de la trasferencia.
     * @param historiaReceptor historia del destinatario
     * @param numeroCuentaTransferir  numero de cuenta del destinatario.
     */
    ...
    /**
     * El método actualiza los saldo en las diferentes cuentas .
     * @param numeroCuentaTransferir numero de cuenta del destinatario.
     * @param saldoTransferir  monto que se transferira.
     */
    ...
    /**
     * el método verificara si la cuenta guarda dolares.
     * @param numerocuenta numero de cuenta de la que se quiere saber si guarda dolares.
     * @return true si la cuenta guarda dolares.
     */
     ...
     * @param numeroCuenta numero de cuenta de la que se quiere saber su saldo.
    ...
    /**
     * El método verifica si la cuenta existe en la lista de cuentas.
     * @param numeroCuenta numero de cuenta de la cuenta de la que se quiere saber si existe en la lista de cuentas.
     * @return true si la cuenta exite en la lista.
     */
